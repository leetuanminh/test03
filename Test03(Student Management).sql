...
(
	...
	class_id INT REFRENCES CLASSROOM(class_id) PRIMARY KEY(student_id, class_id)
)
GO
...
(
	student_id INT REFRENCES STUDENT(student_id),
	subject_id INT REFRENCES SUBJECT(subject_id) PRIMARY KEY(student_id, subject_id)
)
GO

INSERT INTO STUDENT VALUES 
	(N'Tuấn',21,N'Hà Đông',1),
	(N'Minh',21,N'Hà Tây',1)
GO
